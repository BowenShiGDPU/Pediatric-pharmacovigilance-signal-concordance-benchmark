# Public data sources and reuse boundaries

This project uses public spontaneous-reporting databases:

- FDA Adverse Event Reporting System (FAERS/AERS)
...
Controlled vocabularies and ontologies may have separate licenses. In
